...
const LoginForm = ({
  ...
  return (
    <div className="w-full lg:w-2/5 xl:w-1/3 flex items-center justify-center px-6 sm:px-16 lg:px-12 xl:px-16 relative">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <InputBox
                ...
                leftIcon={<Mail className="w-5 h-5 text-txt-sub" />}
              />
            </div>
            ...
            <div className="flex flex-col gap-2 relative">
              <InputBox
                ...
                className="bg-white transition-all"
                leftIcon={<Lock className="w-5 h-5 text-txt-sub" />}
                ...
                rightIcon={
                  ...
                  >
                    {showPw ? (
                      <Eye className="w-5 h-5 text-txt-sub" />
                    ) : (
                      <EyeOff className="w-5 h-5 text-txt-sub" />
                    )}
                  </button>
                }
              />
