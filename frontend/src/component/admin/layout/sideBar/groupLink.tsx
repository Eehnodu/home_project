// 역할: 사이드바 그룹 메뉴. 펼친 상태는 아코디언, 접힌 상태는 hover 플라이아웃
...
const GroupLink = ({ item, collapsed }: GroupProps) => {
  ...
  /* 아이콘에서 플라이아웃으로 마우스를 옮기는 사이 틈에서 닫히지 않게 100ms 늦춘다 */
  const scheduleHide = () => {
  ...
  return (
    <div className="pb-2 text-left">
      ...
      {collapsed && hovered && (
        <div
          className="fixed z-50 bg-[#1c1917] border border-[#292524] rounded-lg py-1 min-w-[160px] shadow-lg"
