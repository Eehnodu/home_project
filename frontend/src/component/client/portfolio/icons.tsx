/**
 * src/assets/portfolio/*.svg 의 path 를 컴포넌트로 옮긴 것.
 * 원본 SVG 는 fill 지정이 없어 <img> 로 넣으면 검정으로 렌더되어 다크모드에서 보이지 않는다.
 * fill="currentColor" 로 두어 상위 텍스트 색을 그대로 따라가게 한다.
 */
interface IconProps {
  className?: string;
}
...
export const TistoryIcon = ({ className = "h-4 w-4" }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
