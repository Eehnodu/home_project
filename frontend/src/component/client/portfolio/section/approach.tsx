...
const FALLBACK: ApproachCard[] = [
  ...
  },
  {
    ...
    title: "AI 의 신뢰 경계",
    description:
      "계산과 판정은 코드가 하고, AI 에는 설명과 정리만 맡깁니다. AI 가 만든 SQL 은 허용 목록 검사를 통과해야만 실행하고, 확정값이 필요한 질문은 별도 호출로 분리해 서버가 결정합니다.",
  },
  {
    icon: "wrench",
    title: "운영을 전제한 로그",
  ...
  },
  {
    ...
    title: "결정과 이유의 기록",
    description:
      "결정과 그 이유를 기록으로 남깁니다. 문제가 생기면 현상, 원인, 조치를 정리해 공유하고, 같은 논의를 반복하지 않게 합니다.",
  },
];
...
const ApproachSection = () => {
  ...
  return (
    <SectionWrapper
      id="approach"
      title="Approach"
      subtitle="개발할 때 중요하게 생각하는 원칙입니다."
      icon={Lightbulb}
    >
      {isLoading ? (
        <ApproachSkeleton />
