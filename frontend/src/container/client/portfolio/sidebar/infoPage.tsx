...
const Card = ({
  ...
  <div className="flex flex-col gap-4 rounded-2xl border border-line px-6 py-5">
    {title && (
      <p className="text-xs font-semibold tracking-wide text-txt-sub">{title}</p>
    )}
    {children}
  </div>
);
...
const InfoPage = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-[300px_1fr]">
      ...
      <div className="flex h-full flex-col items-center gap-4 rounded-2xl border border-line px-6 py-8 text-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-xs font-semibold tracking-wide text-txt-sub">
            {data.role_label}
          </p>
        </div>
        {data.tags.length > 0 && (
